      ...
      <div className="w-full max-w-5xl bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 md:p-12">
            ...
            <h1 className="text-3xl md:text-4xl font-semibold mb-2 tracking-tight">Welcome back</h1>
            ...
            <form className="space-y-4" onSubmit={handleSignIn}>
              ...
              <div className="flex items-center gap-2">
                <input id="remember" type="checkbox" className="rounded border-gray-300 text-[#7c3aed] focus:ring-[#7c3aed]" />
            ...
            <p className="mt-6 text-center text-sm text-gray-500">
              Don’t have an account? <a href="/auth/signup" className="text-[#7c3aed] hover:underline">Sign up</a>
            </p>
          </div>
